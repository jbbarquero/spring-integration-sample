...
package com.malsolo.springframework.integration.sample;
...
/**
 * This Spring Integration transformation handler takes the input file, converts the file into a string, converts the file contents into an
 * upper-case string and then sets a few Spring Integration message headers.
 *
 * @author Javier
 * @since 1.0
 */
